...
<?php 
 ...
 class DbOperation {
     ...
     function addUserInLogin($uname,$pass,$fn,$des) {
         $zero =0;
         $pword = $pass;
         ...
         if($stmt->num_rows <= 0) {
            ...
            $stmt2 = $this->con->prepare("INSERT INTO employee VALUES (?,?,?,?);");
            $stmt2->bind_param("ssss",$uname,$fn,$des,$zero);
            if($stmt2->execute()) {
                return true; 
            }else return false;
         }
